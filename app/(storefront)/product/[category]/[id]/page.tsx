      ...
      <section className='flex flex-col gap-4 lg:flex-1'>
        ...
        <div className='my-6 flex flex-col gap-4'>
          ...
          <p className='text-text-lightGray'>
            Experience the Zen of flavors with our Matcha Cake. Every layer is a
            dance of fine Japanese matcha and creamy richness. Its vibrant green
            hue promises a cake that's both refreshingly earthy and delightfully
            sweet. Dive into this fusion of tradition and taste, perfect for
            discerning palates.
          </p>
        </div>
      </section>
